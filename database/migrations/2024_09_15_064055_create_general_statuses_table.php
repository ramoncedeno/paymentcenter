...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('general_statuses', function (Blueprint $table) {
            ...
            $table->boolean('general_status_is_for_employees_table')->comment('');
            $table->boolean('general_status_is_for_customers_table')->comment('');
            $table->boolean('general_status_is_for_sales_table')->comment('');
            $table->boolean('general_status_is_for_cancellations_table')->comment('');
            $table->boolean('general_status_is_for_payments_employees_table')->comment('');
            $table->boolean('general_status_is_for_payments_supervisors_table')->comment('');

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            // //forein keys
            // $table->foreign('product_idname')->references('id')->on('products');
            // $table->foreign('status_sale')->references('id')->on('general_statuses');
            // $table->foreign('status_cancellation')->references('id')->on('general_statuses');
            // $table->foreign('status_trade')->references('id')->on('trades');
